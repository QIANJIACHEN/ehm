        ...
        <div class="weui-panel__bd">
          ...
          <a href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg open-popup" data-target="#half">
	            ...
	            <div class="weui-media-box__bd">
	              ...
	              <p class="weui-media-box__desc">发动机ID:</p>
	            </div>
          </a>
      ...
      <div class="weui-popup__modal">
        ...
        <div class="modal-content">
		      ...
		      <div class="weui-form-preview__bd">
		        ...
		        <div class="weui-form-preview__item">
		          <label class="weui-form-preview__label">拆发时间</label>
		          <span class="weui-form-preview__value"></span>
		        </div>
		        <div class="weui-form-preview__item">
		        ...
		        <div class="weui-form-preview__item">
		          <label class="weui-form-preview__label">INSTALL_PLAN</label>
		          <span class="weui-form-preview__value"></span>
		        </div>
		        <div class="weui-form-preview__item">
		          <label class="weui-form-preview__label">LLP_SAP</label>
		          <span class="weui-form-preview__value"></span>
		        </div>
		        <div class="weui-form-preview__item">
		          <label class="weui-form-preview__label">CONFIG_ACCESS</label>
		          <span class="weui-form-preview__value"></span>
		        </div>
		      </div>
		    </div>
