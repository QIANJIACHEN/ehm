			...
			<div class="weui-panel weui-panel_access">
				<a href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg">
			      ...
			      <div class="weui-media-box__hd">
			        <img class="weui-media-box__thumb" src="../images/wechat/avatar4.png" alt="">
			      </div>
			    </a>
			    <div class="weui-panel__bd">
		          <div class="weui-media-box weui-media-box_text">
		            <h4 class="weui-media-box__title">王大锤&nbsp;&nbsp;研发工程师</h4>
		            <p class="weui-media-box__desc">wangdachui@sea.com.cn</p>
		            <p class="weui-media-box__desc" style="padding-top: 10px;">18012345678</p>
		          </div>
		        </div>
			</div>
		</div>
