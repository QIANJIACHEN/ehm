...
<div class="modal fade" id="hptnhistory-info-modal" tabindex="-1" role="dialog" aria-labelledby="hptnhistory-info-modal-label">
    <div class="modal-dialog" role="document">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">hptn历史记录信息</h3>
            </div>
            <form id="form-info" method="post" enctype="multipart/form-data">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="edithptnPn"
                               placeholder="hptnPn">
                    </div>
                    <div class="form-group">
                        <label for="text-nickname">hptnSn</label>
                        <input type="text" class="form-control" id="edithptnSn"
                               placeholder="hptnSn">
                    </div>
                    <div class="form-group">
                ...
                <div class="box-footer" style="text-align: right;">
                    <button type="button" class="btn btn-primary" onclick="edithptnhistory()">保存</button>
