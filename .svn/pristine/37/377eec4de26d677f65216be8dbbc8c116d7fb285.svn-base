        ...
        <div class="box-header with-border">
            <div class="row">
                ...
                <div class="col-xs-2" style="min-width: 100px">
                   ...
                   机号：<input type="text" style="display:inline-block;width:100px;" class=" form-control" id="search-tail" placeholder="机号">
                
                
                </div>
                 <div class="col-xs-2" style="min-width: 160px">
                 
             发动机编号：       <input type="text" style="display:inline-block;width:100px;" class=" form-control" id="search-engSn" placeholder="发动机编号">
    ...
    "columnDefs": [
    	{
 			...
 			"render" : function(data, type, row) {
 				return "<a href='javascript:void(0)' title1='11' tail='"+(data == null ? '-' : data)+"' onclick='jumpPlane(this)'>" + (data == null ? '-' : data)
 						+ "</a>";
 			}
 		},
    	{
    	...
    	},
    	{
         	"targets" : 4,
 			"render" : function(data, type, row) {
 				return "<a href='javascript:void(0)' title1='11' engSn='"+(data == null ? '-' : data)+"' onclick='jumpEng(this)'>" + (data == null ? '-' : data)
 						+ "</a>";
 			}
 		},
        {
