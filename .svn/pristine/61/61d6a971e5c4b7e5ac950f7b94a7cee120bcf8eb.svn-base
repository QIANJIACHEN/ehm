...
<div class="modal fade" id="hptbactivity-add-modal" tabindex="-1" role="dialog" aria-labelledby="hptbactivity-add-modal-label">
    <div class="modal-dialog" role="document">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">新建hptb</h3>
            </div>
            <form id="form-add" method="post" enctype="multipart/form-data">
                ...
                <div class="box-footer" style="text-align:right">
                    ...
                    <button type="button" class="btn btn-primary " onclick="addhptbactivity()">新建</button>
