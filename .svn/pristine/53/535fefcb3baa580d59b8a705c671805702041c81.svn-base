    ...
    <div class="box wrapper " style="overflow: auto;">
        ...
        <div class="box-header with-border">
            <div class="row">
                ...
                <div class="col-xs-1" style="min-width: 160px">
                    <button style="background:#f4f4f4;border-color:#ddd;color:black" id="i" class="btn btn-block btn-defauly col-sm-1" data-toggle="modal" data-target="#dataplane-add-modal">
         ...
         },
        {
            ...
            "render": function (data, type, full, meta) {
                ...
                var result = '<div class="btn-group open">'
                    ...
                    + '<button class="btn btn-default btn-sm" tail="'+data.tail+'" onclick="jump(this)" ><i class="fa fa-space-shuttle" aria-hidden="true"></i></button>'
                    + '</div>'
