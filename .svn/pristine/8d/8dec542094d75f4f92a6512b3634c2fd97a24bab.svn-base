...
<div class="modal fade" id="hptbhistory-add-modal" tabindex="-1" role="dialog" aria-labelledby="hptbhistory-add-modal-label">
    <div class="modal-dialog" role="document">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">新建hptb历史记录</h3>
            </div>
            <form id="form-add" method="post" enctype="multipart/form-data">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="addhptbPn"
                               placeholder="hptbPn">
                    </div>
                    <div class="form-group">
                        <label for="text-nickname">hptbSn</label>
                        <input type="text" class="form-control" id="addhptbSn"
                               placeholder="hptbSn">
                    </div>
                    <div class="form-group">
                ...
                <div class="box-footer" style="text-align:right">
                    ...
                    <button type="button" class="btn btn-primary " onclick="addhptbhistory()">新建</button>
