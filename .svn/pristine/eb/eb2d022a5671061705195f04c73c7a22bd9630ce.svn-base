    ...
    <div class="box wrapper " style="overflow: auto;">
        ...
        <div class="box-header">
            ...
            <div class="dataTables_wrapper form-inline dt-bootstrap table-responsive">
                <table style="margin-bottom:60px;" class="table  table-hover table-bordered planetable"> 
                	<tr>
                	...
                	<tr>
                		...
                		<td><span class="key">左发</span></td>
                		<td><span class="val" ><a id="engSn1" href="javascript:void(0)" title1="2" engSn="" onclick="jumpEng(this)" ></a></span></td>
                	</tr>
                	<tr>
                		...
                		<td><span class="key">右发</span></td>
                		<td><span class="val" ><a id="engSn2" href="javascript:void(0)" title1="2" engSn="" onclick="jumpEng(this)" ></a></span></td>
                	</tr>
                </table> 
                <h4>备注</h4>
                <div id="remark" style="width: 100%;height: 300px;border: none;">2014-06-30</div>
            </div>
        </div>
       <!--  <div class="box-body">
...
if(res.data!=null&&res.data!=""&&res.data!="undefined"){
	$.each(res.data,function(index,item){
		if(item.engPosition=="2"){
			//position = "右发";
			$("#engSn2").html(item.engSn);
			$("#engSn2").attr("engSn",item.engSn);
		}else if(item.engPosition=="1"){
			//position = "左发";
			$("#engSn1").html(item.engSn);
			$("#engSn1").attr("engSn",item.engSn);
		}
