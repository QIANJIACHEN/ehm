...
<div class="modal fade" id="lptn1history-add-modal" tabindex="-1" role="dialog" aria-labelledby="lptn1history-add-modal-label">
    <div class="modal-dialog" role="document">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">新建lptn1历史记录</h3>
            </div>
            <form id="form-add" method="post" enctype="multipart/form-data">
                ...
                <div class="box-footer" style="text-align:right">
                    ...
                    <button type="button" class="btn btn-primary " onclick="addlptn1history()">新建</button>
