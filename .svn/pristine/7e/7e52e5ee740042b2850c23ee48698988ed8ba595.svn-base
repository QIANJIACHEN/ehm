        ...
        <div class="weui-panel__bd">
          ...
          <a href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg open-popup" data-target="#half">
	            ...
	            <div class="weui-media-box__bd">
	              ...
	              <p class="weui-media-box__desc">水洗人员:</p>
	            </div>
          </a>
      ...
      <div class="weui-popup__modal">
        ...
        <div class="modal-content">
		      ...
		      <div class="weui-form-preview__bd">
		        ...
		        <div class="weui-form-preview__item">
		          <label class="weui-form-preview__label">水洗时间</label>
		          <span class="weui-form-preview__value"></span>
		        </div>
		        <div class="weui-form-preview__item">
		        ...
		        <div class="weui-form-preview__item">
		          <label class="weui-form-preview__label">持续时间</label>
		          <span class="weui-form-preview__value"></span>
		        </div>
		        <div class="weui-form-preview__item">
		          <label class="weui-form-preview__label">效果</label>
		          <span class="weui-form-preview__value"></span>
		        </div>
		        <div class="weui-form-preview__item">
		          <label class="weui-form-preview__label">评级</label>
		          <span class="weui-form-preview__value"></span>
		        </div>
		        <div class="weui-form-preview__item">
		          <label class="weui-form-preview__label">水洗人员</label>
		          <span class="weui-form-preview__value"></span>
		        </div>
		      </div>
		    </div>
