...
<div class="modal fade" id="dataplane-add-modal" tabindex="-1" role="dialog" aria-labelledby="dataplane-add-modal-label">
    <div class="modal-dialog" role="document">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">新建飞机信息</h3>
            </div>
            <form id="form-add" method="post" enctype="multipart/form-data">
                <div class="box-body">
                    <div class="form-group">
                        <label for="text">某个点飞机的唯一标识</label>
                        <input type="tel" class="form-control" id="addtail"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="addratingPlane"
                               placeholder="推力">
                    </div>
                    <div class="form-group">
                        <label for="text">构型</label>
                        <input type="text" class="form-control" id="addconfigPlane"
                               placeholder="构型">
                    </div>
                    <div class="form-group">
                        <label for="text">原始的发动机编码</label>
                        <input type="text" class="form-control" id="addegsnOriginal"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="addattribute"
                               placeholder="属性">
                    </div>
                    <div class="form-group">
                        <label for="text">ETOPS</label>
                        <input type="text" class="form-control" id="addetops"
                               placeholder="ETOPS">
                    </div>
                    <div class="form-group">
                        <label for="text">高高原</label>
                         <select id="addhHighLand" name="roletype" class="form-control" style="width: 100%">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="addvariable"
                               placeholder="VARIABLE">
                    </div>
                    <div class="form-group">
                        <label for="text">MSN</label>
                        <input type="text" class="form-control" id="addserial"
                               placeholder="MSN">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="addeffectivity"
                               placeholder="手册适用性">
                    </div>
                    <div class="form-group">
                        <label for="text">营运人</label>
                        <input type="text" class="form-control" id="addoperater"
                               placeholder="营运人">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="addimportWay"
                               placeholder="引进方式">
                    </div>
                    <div class="form-group">
                ...
                <div class="box-footer" style="text-align:right">
                    ...
                    <button type="button" class="btn btn-primary" onclick="adddataplane()">新建</button>
