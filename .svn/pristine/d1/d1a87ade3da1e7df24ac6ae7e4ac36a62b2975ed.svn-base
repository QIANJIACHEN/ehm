        ...
        <div class="box-header with-border">
            <div class="row">
                ...
                <div class="col-xs-1 pull-right" style="min-width: 160px">
                    <a href="${pageContext.request.contextPath}/manage/shakemonitor/shakechart.do" class="btn btn-block btn-primary col-sm-1">
                       	 生成图表
                    </a>
                </div>
                <!-- <div class="col-xs-1 pull-right" style="min-width: 160px">
...
<script type="text/javascript">
	        ...
	        },
	    	{
	         ...
	         },
	         {
	             ...
	             "render": function (data, type, full, meta) {
	                 var table = $("#table-engineer").DataTable();
 ...
 //详情跳转
	 function jump(id){
	 	url="${pageContext.request.contextPath}/manage/shakemonitor/shakemonitordetail.do?id="+id;
	 	title = "震动监控数据详请";
