...
public class UserController extends BaseController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/listByDuty.do")
	@ResponseBody
	public Map<String, Object> listByDuty(@RequestParam Map<String, String> reqPara) {
		String duty = reqPara.get("duty");
		Map<String, Integer> map = Maps.newHashMap();
		if (!Strings.isNullOrEmpty(duty)) {
			map.put("duty", Integer.parseInt(duty));
		}
		List<User> users = userService.listByDuty(map);
