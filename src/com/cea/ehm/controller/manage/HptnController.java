...
public class HptnController extends BaseController {
	...
	public Map<String, Object> saveHptnActivity(@RequestParam Map<String, String> reqPara) {
		...
		HptnActivity selectHptnActivity = hptnService.selectHptnActivity(hptnActivity);
		if (selectHptnActivity != null) {
	...
	public Map<String, Object> saveHptnHistory(@RequestParam Map<String, String> reqPara) {
		...
		HptnHistory selectHptnHistory = hptnService.selectHptnHistory(hptnHistory);
		if (selectHptnHistory != null) {
			return getFailureMessage(ConstantUtil.RES_MSG_EXIST, 1);
		}
