...
<div class="modal fade" id="hptnactivity-info-modal" tabindex="-1" role="dialog" aria-labelledby="hptnactivity-info-modal-label">
    <div class="modal-dialog" role="document">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">hptn信息</h3>
            </div>
            <form id="form-info" method="post" enctype="multipart/form-data">
                ...
                <div class="box-footer" style="text-align: right;">
                    <button type="button" class="btn btn-primary" onclick="edithptnactivity()">保存</button>
