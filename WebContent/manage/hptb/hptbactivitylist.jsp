        ...
        <div class="box-header with-border">
          ...
          <div class="row">
                ...
                <div class="col-xs-1" style="min-width: 160px">
                    ...
                    <button class="btn btn-block btn-primary col-sm-1" data-toggle="modal" data-target="#hptbactivity-add-modal">
...
// 编辑按钮 → 信息填充
 ...
 function addhptbactivity() {
	 ...
	 * 清除弹窗原数据
	 */
	$("#hptbactivity-add-modal").on("hidden.bs.modal", function() {
		$('#reset').click();
	});
