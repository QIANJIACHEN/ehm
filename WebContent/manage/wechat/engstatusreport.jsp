      ...
      <div class="weui-popup__modal">
        ...
        <div class="modal-content">
		      ...
		      <div class="weui-form-preview__bd">
		        ...
		        <div class="weui-form-preview__item">
		          <label class="weui-form-preview__label">机型</label>
		          <span class="weui-form-preview__value"></span>
		        </div>
		        <div class="weui-form-preview__item">
		        ...
		        <div class="weui-form-preview__item">
		          <label class="weui-form-preview__label">TSI_START</label>
		          <span class="weui-form-preview__value"></span>
		        </div>
		        <div class="weui-form-preview__item">
		          <label class="weui-form-preview__label">CSI_START</label>
		          <span class="weui-form-preview__value"></span>
		        </div>
		        <div class="weui-form-preview__item">
		          <label class="weui-form-preview__label">SV_TIME</label>
		          <span class="weui-form-preview__value"></span>
		        </div>
		        <div class="weui-form-preview__item">
		          <label class="weui-form-preview__label">TSR_START</label>
		          <span class="weui-form-preview__value"></span>
		        </div>
		        <div class="weui-form-preview__item">
		          <label class="weui-form-preview__label">TSO_START</label>
		          <span class="weui-form-preview__value"></span>
		        </div>
		        <div class="weui-form-preview__item">
		          <label class="weui-form-preview__label">CSO_START</label>
		          <span class="weui-form-preview__value"></span>
		        </div>
		      </div>
		    </div>
