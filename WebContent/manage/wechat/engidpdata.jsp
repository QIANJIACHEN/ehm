        ...
        <div class="weui-panel__bd">
          ...
          <a href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg open-popup" data-target="#half">
	            ...
	            <div class="weui-media-box__bd">
	              ...
	              <p class="weui-media-box__desc">发动机设备编号:</p>
	            </div>
          </a>
        </div>
      ...
      <div class="weui-popup__modal">
        <div class="toolbar">
          <div class="toolbar-inner">
            ...
            <h1 class="title">IDPLUG数据基本信息</h1>
          </div>
        </div>
        <div class="modal-content">
		      ...
		      <div class="weui-form-preview__hd">
		        <div class="weui-form-preview__item">
		          <label class="weui-form-preview__label">IDPLUG_PN</label>
		      ...
		      <div class="weui-form-preview__bd">
		        ...
		        <div class="weui-form-preview__item">
		          <label class="weui-form-preview__label">发动机设备编号</label>
		          <span class="weui-form-preview__value"></span>
		        </div>
		        <div class="weui-form-preview__item">
		          <label class="weui-form-preview__label">发动机型号</label>
		          <span class="weui-form-preview__value"></span>
		        </div>
		        <div class="weui-form-preview__item">
		          <label class="weui-form-preview__label">转速</label>
		          <span class="weui-form-preview__value"></span>
		        </div>
		        <div class="weui-form-preview__item">
		        ...
		        <div class="weui-form-preview__item">
		          <label class="weui-form-preview__label">飞机型号</label>
		          <span class="weui-form-preview__value"></span>
		        </div>
		      </div>
		    </div>
