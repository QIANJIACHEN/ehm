        ...
        <div class="weui-panel__bd">
          ...
          <a href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg open-popup" data-target="#half">
	            ...
	            <div class="weui-media-box__bd">
	              ...
	              <p class="weui-media-box__desc">z状态：起飞</p>
	            </div>
          </a>
        ...
        <div class="modal-content">
		      ...
		      <div class="weui-form-preview__bd">
		        ...
		        <div class="weui-form-preview__item">
		          ...
		          <span class="weui-form-preview__value">521555</span>
		        </div>
		        <div class="weui-form-preview__item">
		        ...
		        <div class="weui-form-preview__item">
		          <label class="weui-form-preview__label">OIL_CONSUMPTION</label>
		          <span class="weui-form-preview__value">0.3509</span>
		        </div>
		        <div class="weui-form-preview__item">
		          <label class="weui-form-preview__label">SCORE_OIL_CONSUMPTION</label>
		          <span class="weui-form-preview__value">60.00</span>
		        </div>
