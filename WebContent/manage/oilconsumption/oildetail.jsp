        	...
        	<div class="row basicinfo">
        		<div class="col-md-3 col-xs-3">
        			<p>
        				...
        				<span class="val"><a id="duty" title1="7" onclick="jumpDuty(this)" href="javascript:void(0)" ></a></span>
        			</p>
        			<p>
        			...
        			<p>
        				...
        				<span class="val"><a id="tail" title1="7" href="javascript:void(0)" onclick="jumpPlane(this)" ></a></span>
        			</p>
        		</div>
        		<div class="col-md-3 col-xs-3">
        			<p>
...
$.post("${pageContext.request.contextPath}/manage/oilconsumption/info.do",{id:id},function(res){
	...
	$("#userid").html(res.data[0].username);
	$("#userid").attr("userid",res.data[0].userId);
