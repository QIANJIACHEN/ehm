...
<div class="modal fade" id="lptn1activity-info-modal" tabindex="-1" role="dialog" aria-labelledby="lptn1activity-info-modal-label">
    <div class="modal-dialog" role="document">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">lptn1信息</h3>
            </div>
            <form id="form-info" method="post" enctype="multipart/form-data">
                ...
                <div class="box-footer" style="text-align: right;">
                    <button type="button" class="btn btn-primary" onclick="editlptn1activity()">保存</button>
