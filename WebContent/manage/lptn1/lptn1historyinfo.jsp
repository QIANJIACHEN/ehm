...
<div class="modal fade" id="lptn1history-info-modal" tabindex="-1" role="dialog" aria-labelledby="lptn1history-info-modal-label">
    <div class="modal-dialog" role="document">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">lptn1历史记录信息</h3>
            </div>
            <form id="form-info" method="post" enctype="multipart/form-data">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input readonly="readonly" type="text" class="form-control" id="editengSnUsed"
                               placeholder="engSnUsed">
                    </div>
                    <div class="form-group">
                        <label for="text-nickname">lptn1Pn</label>
                        <input type="text" class="form-control" id="editlptn1Pn"
                               placeholder="lptn1Pn">
                    </div>
                    <div class="form-group">
                        <label for="text-nickname">lptn1Sn</label>
                        <input type="text" class="form-control" id="editlptn1Sn"
                               placeholder="lptn1Sn">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="editoffDate"
                               placeholder="offDate">
                    </div>
                    <div class="form-group">
                        <label for="text-nickname">offEtsn</label>
                        <input type="text" class="form-control" id="editoffEtsn"
                               placeholder="offEtsn">
                    </div>
                    <div class="form-group">
                        <label for="text-nickname">offEcsn</label>
                        <input type="text" class="form-control" id="editoffEcsn"
                               placeholder="offEcsn">
                    </div>
                    <div class="form-group">
                        <label for="text-nickname">offPtsn</label>
                        <input type="text" class="form-control" id="editoffPtsn"
                               placeholder="offPtsn">
                    </div>
                    <div class="form-group">
                        <label for="text-nickname">offPcsn</label>
                        <input type="text" class="form-control" id="editoffPcsn"
                               placeholder="offPcsn">
                    </div>
                    <div class="form-group">
                ...
                <div class="box-footer" style="text-align: right;">
                    <button type="button" class="btn btn-primary" onclick="editlptn1history()">保存</button>
