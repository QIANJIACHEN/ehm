        ...
        <div class="box-header with-border">
            ...
            <!-- 
                ...
                <div class="col-xs-1" style="min-width: 160px">
                    <button class="btn btn-block btn-default" onclick="searchfleeteng()">
                ...
                <div class="col-xs-1" style="min-width: 160px">
                    <button class="btn btn-block btn-default col-sm-1" data-toggle="modal" data-target="#fleeteng-add-modal">
...
<jsp:include page='fleetenginfo.jsp'/>
<jsp:include page='fleetengadd.jsp'/>
...
$("#table-list").DataTable({
    ...
    "type": "POST",
    "ajax": {
        "url": "${pageContext.request.contextPath}/manage/fleeteng/list.do",
        "type": "POST",
        "data": function (d) {
        	// 条件查询参数
    	...
    	},
        {
            ...
            "render": function (data, type, full, meta) {
                ...
                var result = '<div class="btn-group open">'
                    ...
                    + ' data-toggle="modal" data-target="#fleeteng-info-modal">'
                    + '<i class="fa fa-gear"></i>'
                    + '</button><button class="btn btn-default btn-sm" onclick="deletefleeteng(' + data.id + ')">'
...
// 编辑按钮 → 机队清单填充
 ...
 function editfleeteng() {
		...
		$.post(
		    ...
		    function (res) {
		    	 $('#fleeteng-info-modal').modal('hide');
		         reloadTable(true);
		    },
		    "json"
		);
 ...
 // search 
 function searchfleeteng() {
	 var table = $('#table-list').DataTable();
	 table.ajax.reload(null, true);
 }
 
// delete
 function deletefleeteng(id) {
     if (confirm("你确定要删除吗？")) {
         $.post(
             "${pageContext.request.contextPath}/manage/fleeteng/delete.do",
             {
                 "id": id,
             },
             function (response) {
...
//获取飞机
 ...
 // excel 导出
	 $('#export').click(function(){
		 window.location = '${pageContext.request.contextPath}/manage/fleeteng/export.do';
	 });
	 
	// 调用OCUpload插件的方法
	$("#inport").upload({
	     action: "${pageContext.request.contextPath}/manage/fleeteng/inport.do", //表单提交的地址
	     name: "file",
